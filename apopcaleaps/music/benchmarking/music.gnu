...
'data1'  with linespoints lt 1 pt 1 lw 2 title "original",\
'data2' with linespoints  lt 2 pt 2 lw 2 title "NR",\
'data3'  with linespoints lt 3 pt 3 lw 2 title "NRS",\
'data4' with linespoints  lt 4 pt 4 lw 2 title "NRSU"
