/*  $Id: chr_compiler_utility.pl,v 1.8 2006/04/11 14:25:34 toms Exp $
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 time(Phase,Goal) :-
 	...
 	T is T2 - T1,
 	format('    ~w:\t\t~w ms\n',[Phase,T]).
%time(Phase,Goal) :- writeln(Phase),call(Goal),statistics.
