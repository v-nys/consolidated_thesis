...
generate_indexed_variables_clause(A/B, C) :-
        ...
        (   H==empty ->
            J=(G=[])
        ;   I==0 ->
            J=term_variables(K,G)
        ;   H=J
        ),
        internal_call(indexed_variables, [K,G], L),
        C=(L:-K=D,J).
...
generate_extra_clauses(A, [B,C,D,E,F]) :-
        ...
        ;   internal_call(chr_indexed_variables, [G,H], I),
            E=(I:-'chr chr_indexed_variables'(G,H))
        ),
...
generate_remove_clause(A) :-
        internal_call(remove_constraint_internal, [B,C,D], E),
        internal_call(chr_indexed_variables, [B,C], F),
        A=(E:-arg(2,B,G),'chr get_mutable'(H,G),'chr update_mutable'(removed,G),(compound(H)->C=[],D=no ; H==removed->C=[],D=no ; D=yes,F)).
generate_activate_clause(A) :-
        internal_call(activate_constraint, [B,C,D,E], F),
        internal_call(chr_indexed_variables, [D,C], G),
        A=(F:-arg(2,D,H),'chr get_mutable'(I,H),'chr update_mutable'(active,H),(nonvar(E)->true ; arg(4,D,J),'chr get_mutable'(K,J),E is K+1,'chr update_mutable'(E,J)),(compound(I)->term_variables(I,C),'chr none_locked'(C),B=yes ; I==removed->G,B=yes ; C=[],B=no)).
generate_allocate_clause(A) :-
        internal_call(allocate_constraint, [B,C,D,E], F),
        internal_call(chr_indexed_variables, [C,G], H),
        A=(F:-C=..[suspension,I,J,B,K,L,D|E],'chr create_mutable'(0,K),'chr empty_history'(M),'chr create_mutable'(M,L),H,'chr create_mutable'(passive(G),J),'chr gen_id'(I)).
generate_insert_constraint_internal(A) :-
        internal_call(insert_constraint_internal, [yes,B,C,D,E,F], G),
        internal_call(chr_indexed_variables, [C,B], H),
        A=(G:-C=..[suspension,I,J,D,K,L,E|F],H,'chr none_locked'(B),'chr create_mutable'(active,J),'chr create_mutable'(0,K),'chr empty_history'(M),'chr create_mutable'(M,L),'chr gen_id'(I)).
global_indexed_variables_clause(A, B) :-
        (   forsome(C, A, chr_translate:may_trigger(C)) ->
            internal_call(indexed_variables, [D,E], F),
            G=(H=..[_,_,_,_,_,_,D|_],F)
        ;   G=true,
            E=[]
        ),
        internal_call(chr_indexed_variables, [H,E], I),
        B=(I:-G).
...
constraint_prelude(A/B, C) :-
        ...
        J=..[A|D],
        (   chr_pp_flag(debugable, on) ->
            internal_call(allocate_constraint, [I:H,E,J,D], K),
            C=(G:-K,('chr debug_event'(call(E)),H ; 'chr debug_event'(fail(E)),'!',fail),('chr debug_event'(exit(E)); 'chr debug_event'(redo(E)),fail))
        ;   C=(G:-H)
        ).
...
gen_cond_attach_goal(A/B, C, D, E, F) :-
        ...
        internal_call(insert_constraint_internal, [N,J,F,K:G,L,E], O),
        internal_call(activate_constraint, [N,J,F,_], P),
        C=((var(F)->O ; P),(N==yes->M,I ; true)).
gen_insert_constraint_internal_goal(A/B, C, D, E, F) :-
        ...
        L=..[A|E],
        generate_insert_constraint_call(A/B, F, M),
        internal_call(insert_constraint_internal, [_,J,F,K:G,L,E], N),
        C=(N,M,I).
gen_uncond_attach_goal(A, B, C, D) :-
        ...
        internal_call(activate_constraint, [I,G,B,D], J),
        C=(J,(I==yes->H,F ; true)).
...
gen_allocation(A, B, C/D, E, F) :-
        ...
        get_target_module(H),
        I=..[C|A],
        internal_call(allocate_constraint, [H:G,B,I,A], J),
        F=J.
gen_allocation(A, B, C, D, E, F) :-
        (   A==[0] ->
            (   is_attached(D) ->
...
discover_unique_pattern(A, B, C) :-
        ...
        check_unique_constraints(I, J, H, B, K),
        term_variables(I, L),
...
gen_uncond_susp_detachment(A, B, C) :-
        (   is_attached(B) ->
            ...
            internal_call(remove_constraint_internal, [A,F,I], J),
...
'$chr_translate__allocate_constraint'(A, B, C, D) :-
        ...
        'chr gen_id'(F).
'$chr_translate__chr_indexed_variables'(_, []).
...
'constraint/2__0'(A, B, C) :-
        '$chr_translate__insert_constraint_internal'(_, _, C, chr_translate:'constraint/2__0'(A,B,C), constraint(A,B), [A,B]),
...
'constraint_count/1__0'(A, B) :-
        '$chr_translate__insert_constraint_internal'(_, _, B, chr_translate:'constraint_count/1__0'(A,B), constraint_count(A), [A]),
...
'attached/2__0'(A, B, C) :-
        ...
        '$chr_translate__allocate_constraint'(chr_translate:'attached/2__0'(A,B,C), C, attached(A,B), [A,B]),
...
'attached/2__1'(A, _, B) :-
        ...
        (   var(B) ->
            true
        ;   '$chr_translate__remove_constraint_internal'(B, _, H),
            (   H==yes ->
...
'constraint_mode/2__0'(A, B, C) :-
        '$chr_translate__insert_constraint_internal'(_, _, C, chr_translate:'constraint_mode/2__0'(A,B,C), constraint_mode(A,B), [A,B]),
...
'pragma_unique/3__0'(A, B, C, D) :-
        '$chr_translate__insert_constraint_internal'(_, _, D, chr_translate:'pragma_unique/3__0'(A,B,C,D), pragma_unique(A,B,C), [A,B,C]),
...
'allocation_occurrence/2__0'(A, B, C) :-
        '$chr_translate__insert_constraint_internal'(_, _, C, chr_translate:'allocation_occurrence/2__0'(A,B,C), allocation_occurrence(A,B), [A,B]),
